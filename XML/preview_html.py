...
<img id="image-main" class="gallery-image visible" src="./materials1 (25)_files/ag91_1_1.jpg" alt="Telewizor SONY KD-77AG9" title="Telewizor SONY KD-77AG9">

<img id="image-0" class="gallery-image" src="./materials1 (25)_files/ag91_1_1(1).jpg" data-zoom-image="https://matrixmedia.pl/media/catalog/product/cache/1/image/1800x/6b9ffbf72458f4fd2d3cb995d92e8889/a/g/ag91_1_1.jpg">
...
def preview_html(full_product, ean, yes_to_all):
    ...
    if yes_to_all is False:
        print(f'Accept with "Enter" button, decline with "Esc" or mark with "M" ({ean})')

        # wait for a user to confirm it
        while True:
            if keyboard.is_pressed('Enter'):
                print(f'INFO: Accepted: {ean}')
                return 0
            elif keyboard.is_pressed('Esc'):
                print(f'INFO: Declined: {ean}')
                return -1
            elif keyboard.is_pressed('M'):
                print(f'INFO: Marked: {ean}')
                return 1
    else:
        print(f'INFO: Accepted automatially: {ean}')
